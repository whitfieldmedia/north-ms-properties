        ...
        return (
            <div className="home-page">
                ...
                <div className="header-container">
                    <img src={logo} id="home-logo" alt="North Ms Properties"/>
                ...
                <div className="home-button-row">
                    <Link to="/description-of-property">
                        <button className="home-contact-button"> 
                            Learn More <i class="fas fa-chevron-right fa-sm"></i>
                        </button>
                    </Link>
                    <Link to="/contact">
                        <button className="home-contact-button"> 
                            Contact <i class="fas fa-chevron-right fa-sm"></i>
                        </button>
                    </Link>
                </div>
                ...
                <div className="home-bottom-section">
                    ...
                    <div className="home-bottom-column">
                        <h2 className="header2"> Property & Facility Highlights </h2>
